...
Теорема Пифагора позволяет записать равенство $|OH|^2$ + $|РH|^2$ = $|OP|^2$, которое мы можем переписать как $|x|^2$ + $|y|^2$ = $|1|^2$ или $|x|^2$ + $|y|^2$ = 1. Но по определению _sinα = y_ и _cosα = x_, тогда от равенства $|x|^2$ + $|y|^2$ = 1 можно перейти к равенству $cos^2$α + $cos^2$α = 1.
Основное тригонометрическое тождество задает связь между синусом и косинусом одного угла. Это позволяет вычислять синус угла, когда известен косинус этого угла, и вычислять косинус угла, когда известен синус угла. Для этого достаточно равенство  разрешить относительно синуса и косинуса соответственно:  и . Знак перед корнем зависит от величины угла . 
basic_trigonometric_identity.png
basic_trigonometric_identity_formula.png
